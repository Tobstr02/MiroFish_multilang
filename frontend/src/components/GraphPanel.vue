    ...
    <div class="graph-container" ref="graphContainer">
      ...
      <div v-if="graphData" class="graph-view">
        ...
        <div v-if="currentPhase === 1 || isSimulating" class="graph-building-hint">
          ...
          {{ isSimulating ? $t('graph_panel.simulating_hint') : $t('graph_panel.updating_hint') }}
        </div>
          ...
          <div v-else class="detail-content">
            ...
            <template v-if="selectedItem.data.isSelfLoopGroup">
              <div class="edge-relation-header self-loop-header">
                ...
                <span class="self-loop-count">{{ selectedItem.data.selfLoopCount }} {{ $t('graph_panel.items') }}</span>
              </div>
              ...
              <div class="self-loop-list">
                ...
                >
                  ...
                  >
                    ...
                    <span class="self-loop-name">{{ loop.name || loop.fact_type || $t('graph_panel.related') }}</span>
            ...
            <template v-else>
              <div class="edge-relation-header">
                {{ selectedItem.data.source_name }} → {{ selectedItem.data.name || $t('graph_panel.related') }} → {{ selectedItem.data.target_name }}
              </div>
              ...
              <div class="detail-row">
                ...
                <span class="detail-value">{{ selectedItem.data.name || $t('graph_panel.related') }}</span>
              </div>
              <div class="detail-row">
                <span class="detail-label">{{ $t('graph_panel.type') }}:</span>
